...
The bottom-left placement above avoids overlapping `advanced-camera-card`'s PTZ controls, which are typically centered at the bottom of the card. Adjust `bottom`/`left` to taste for your own card layout.
